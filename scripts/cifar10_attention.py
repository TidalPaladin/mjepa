...
from mjepa.visualization.attention import AttentionVisualizer
...
def parse_args() -> Namespace:
    parser = AttentionVisualizer.create_parser(custom_loader=True)
    return parser.parse_args()


def main(args: Namespace) -> None:
    visualizer = AttentionVisualizer.from_args(args)
