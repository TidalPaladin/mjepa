...
class JEPAConfig:
    ...
    Args:
        ...
        disable_predictor_regularizers: Whether to force predictor stochastic depth, hidden dropout,
            and attention dropout to ``0.0``.
        dense_pred_loss_weight: The coefficient of the dense prediction loss.
    ...
    def __post_init__(self) -> None:
        ...
        if self.dense_pred_loss_weight <= 0:
            raise ValueError("dense_pred_loss_weight must be a positive float")
